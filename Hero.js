...
function Hero({sig}) {
  return (
    <section className='h-screen w-screen flex justify-center items-center bg-slate-300/80'>
        <div className='md:h-5/6 md:w-5/6 h-5/6 w-full flex md:flex-row flex-col  bg-slate-600/40 rounded-xl shadow-md'>
